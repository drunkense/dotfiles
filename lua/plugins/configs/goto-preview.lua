...
-- vim.keymap.set("n", "gp", "<cmd>lua require('goto-preview').goto_preview_type_definition()<CR>", { noremap = true })
...
preview.setup {
  ...
  opacity = 100; -- 0-100 opacity level of the floating window where 100 is fully transparent.
